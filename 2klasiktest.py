...
# ==============================================================================
# BAGIAN 2: APLIKASI GUI YANG DISEDERHANAKAN
# ==============================================================================
...
class ChainedCipherApp(customtkinter.CTk):
    def __init__(self):
        ...
        # --- Judul Aplikasi ---
        title_label = customtkinter.CTkLabel(main_frame, text="Playfair & Caesar Chained Cipher", font=("Inter", 32, "bold"))
        ...
        self.result_label = customtkinter.CTkLabel(result_card, text="", font=("Courier New", 18, "bold"), wraplength=650, justify="left", fg_color="#1e1e1e", corner_radius=10)
    ...
    def run_process(self, mode):
        ...
        # --- 2. Jalankan Proses Enkripsi/Dekripsi ---
        try:
            if mode == 'encrypt':
                playfair_result = playfair_process(input_text, playfair_key, 'encrypt')
                final_result = caesar_process(playfair_result, caesar_key, 'encrypt')
            else: # mode == 'decrypt'
                caesar_result = caesar_process(input_text, caesar_key, 'decrypt')
